      ...
      <swiper :slidesPerView="1" :autoHeight="true" :effect="'fade'" :autoplay="{delay: 10000}" :centeredSlides="true" :loop="true" :navigation="{nextEl:'.swiper-button-next',prevEl:'.swiper-button-prev'}" :modules="modules" class="mySwiper" ref="mySwiper" style="width: 100%;" @slideChange="playAnimation">
        ...
        <swiper-slide>
            ...
            <div class="banner-title position-absolute" style="top: 25%;left: 10%;">
              <img src="@/assets/images/banner/banner_home3title.png" alt="天然食材" style="width: 90px;">
            </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <router-link to="/products" class=" product-catena-item col-12 col-md-6 d-block text-center" data-aos="fade-up">
            <div class="img-hover">
              <img class="w-100" src="@/assets/images/prodduct-catena-1.png" alt="涼麵" data-aos="zoom-in" style="width: 95% !important;">
            </div>
            <h4 class="text-center pt-2 pb-4">涼麵系列</h4>
          </router-link>
          <router-link to="/products" class=" product-catena-item col-12 col-md-6 text-center">
            <div class="img-hover">
              <img class="w-100" src="@/assets/images/prodduct-catena-2.png" alt="湯麵" data-aos="zoom-in" style="width: 95% !important;">
            </div>
            <h4 class="text-center pt-2 pb-4">湯麵系列</h4>
          </router-link>
          <router-link to="/products" class=" product-catena-item col-12 col-md-6 text-center">
            <div class="img-hover">
              <img class="w-100" src="@/assets/images/prodduct-catena-3.png" alt="炸物" data-aos="zoom-in" style="width: 95% !important;">
            </div>
            <h4 class="text-center pt-2 pb-4 ">炸物系列</h4>
          </router-link>
          <router-link to="/products" class=" product-catena-item col-12 col-md-6 text-center">
            <div class="img-hover">
              <img class="w-100" src="@/assets/images/prodduct-catena-4.png" alt="小菜" data-aos="zoom-in" style="width: 95% !important;">
            </div>
          ...
          spaceBetween: 20,
               ...
               <swiper-slide class="h-100 pb-4">
                <div class="card  p-4 pb-0 rounded-0 h-100" style="box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;">
                  <img src="@/assets/images/opening.png" class="card-img-top w-100" alt="慶開幕" style="object-fit:cover ; object-position:center center;height:80% !important;">
              ...
              <swiper-slide class="h-100 pb-4">
                <div class="card  p-4 pb-0 rounded-0 h-100" style="box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;">
                  <img src="@/assets/images/news-pic1.jpg" class="card-img-top " alt="端午連假" style="object-fit:cover ; object-position:center center;height:80% !important;">
                  <div class="card-body text-center">
              ...
              <swiper-slide class="h-100 pb-4">
                <div class="card  p-4 pb-0 rounded-0 h-100" style="box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;">
                  <img src="@/assets/images/news-pic2.jpg" class="card-img-top " alt="日式擔仔麵" style="object-fit:cover ; object-position:center center;height:80% !important;">
                  <div class="card-body text-center">
              ...
              <swiper-slide class="h-100 pb-4">
                <div class="card  p-4 pb-0 rounded-0 h-100" style="box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;">
                  <img src="@/assets/images/news-pic4.jpg" class="card-img-top " alt="南洋叻沙雞肉湯麵" style="object-fit:cover ; object-position:center center;height:80% !important;">
                  <div class="card-body text-center">
                    <h5 class="card-title">新品上市</h5>
